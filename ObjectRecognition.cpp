...
int main()
{
	...
	double t; //timing variable
			  ...
			  //load training image
	Mat object = imread("C:\\Users\\Gobind Deep Singh\\Pictures\\train.jpg", CV_LOAD_IMAGE_GRAYSCALE);
	if (!object.data) {
	...
	if (testing)
	{
		...
		imwrite("C:\\Users\\Gobind Deep Singh\\Pictures", iObject);
		cvWaitKey(0);
		...
		int minH;
		std::ofstream file;
		file.open("C:\\Users\\Gobind Deep Singh\\Pictures\\TimingC.csv", std::ofstream::out);
		for (int i = 0; i<20; i++)
		{
		...
		imwrite("C:\\Users\\Gobind Deep Singh\\Pictures\\train.jpg", interestPointObject);
		cvWaitKey(0);
	}
